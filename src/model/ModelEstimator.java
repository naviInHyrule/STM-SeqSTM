...
public class ModelEstimator {
	 ...
	 *            vocabulary
	 */
	public ModelEstimator(Corpus trCorpus, Corpus teCorpus, Parameters trParams,
		...
		if (configs.indicator)
			trSampler = new IndicatorSampler(trCorpus, trParams, configs);
		else
			trSampler = new CollapseSampler(trCorpus, trParams,configs);
